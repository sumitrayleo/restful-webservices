...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
            .apis(RequestHandlerSelectors.basePackage("com.tutorial.restfulwebservices"))
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo =
            new ApiInfoBuilder().title("Test Application").description("Test Application specification").version("1.0").build();
        return apiInfo;
    }
}
